...
public class LogDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + LogContract.LogEntry.TABLE_NAME + " (" +
                    ...
                    LogContract.LogEntry.COLUMN_START_DISTANCE + REAL_NOT_NULL + COMMA_SEP +
                    LogContract.LogEntry.COLUMN_END_DISTANCE + REAL_NOT_NULL + COMMA_SEP +
                    LogContract.LogEntry.COLUMN_GAS_AMOUNT + REAL_NOT_NULL + COMMA_SEP +
                    " )";
